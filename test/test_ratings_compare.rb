...
class TestRatingsCompare < MovieTest
  def test_ratings_compare_produces_poor_rating_difference
    ...
    good_will_hunting = MovieEntry.create(title: "Good Will Hunting", seen: 1, own: 1, wishlist_see: 0, wishlist_own: 0, user_rating: "2", movie: good_will_hunting_movie)
    a_good_year = MovieEntry.create(title: "A Good Year", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 0, user_rating: "5", movie: a_good_year_movie)
    erin_brockovich = MovieEntry.create(title: "Erin Brockovich", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "8", movie: erin_brockovich_movie)
    up = MovieEntry.create(title: "Up", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "32", movie: up_movie)
    magic_mike = MovieEntry.create(title: "Magic Mike", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "100", movie: magic_mike_movie)
    the_notebook = MovieEntry.create(title: "The Notebook", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "100", movie: the_notebook_movie)
    the_holiday = MovieEntry.create(title: "The Holiday", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "91", movie: the_holiday_movie)
    blood_diamond = MovieEntry.create(title: "Blood Diamond", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "21", movie: blood_diamond_movie)
    once = MovieEntry.create(title: "Once", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "15", movie: once_movie)
    ps_i_love_you = MovieEntry.create(title: "P.S. I Love You", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "89", movie: ps_i_love_you_movie)
    american_hustle = MovieEntry.create(title: "American Hustle", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "none", movie: american_hustle_movie)
...
Splat! Your taste sucks. Your average critic rating difference is 55."
  ...
  def test_ratings_compare_produces_best_rating_difference
    ...
    good_will_hunting = MovieEntry.create(title: "Good Will Hunting", seen: 1, own: 1, wishlist_see: 0, wishlist_own: 0, user_rating: "92", movie: good_will_hunting_movie)
    a_good_year = MovieEntry.create(title: "A Good Year", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 0, user_rating: "28", movie: a_good_year_movie)
    erin_brockovich = MovieEntry.create(title: "Erin Brockovich", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "85", movie: erin_brockovich_movie)
    up = MovieEntry.create(title: "Up", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "95", movie: up_movie)
    magic_mike = MovieEntry.create(title: "Magic Mike", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "75", movie: magic_mike_movie)
    the_notebook = MovieEntry.create(title: "The Notebook", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "57", movie: the_notebook_movie)
    the_holiday = MovieEntry.create(title: "The Holiday", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "50", movie: the_holiday_movie)
    blood_diamond = MovieEntry.create(title: "Blood Diamond", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "75", movie: blood_diamond_movie)
    once = MovieEntry.create(title: "Once", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "60", movie: once_movie)
    ps_i_love_you = MovieEntry.create(title: "P.S. I Love You", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "25", movie: ps_i_love_you_movie)
    american_hustle = MovieEntry.create(title: "American Hustle", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "none", movie: american_hustle_movie)
...
Fresh! Quit your day job and move to Hollywood.. Your average critic rating difference is 7."
  ...
  def test_ratings_compare_produces_mid_rating_difference
    ...
    good_will_hunting = MovieEntry.create(title: "Good Will Hunting", seen: 1, own: 1, wishlist_see: 0, wishlist_own: 0, user_rating: "62", movie: good_will_hunting_movie)
    a_good_year = MovieEntry.create(title: "A Good Year", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 0, user_rating: "58", movie: a_good_year_movie)
    erin_brockovich = MovieEntry.create(title: "Erin Brockovich", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "85", movie: erin_brockovich_movie)
    up = MovieEntry.create(title: "Up", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "65", movie: up_movie)
    magic_mike = MovieEntry.create(title: "Magic Mike", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "45", movie: magic_mike_movie)
    the_notebook = MovieEntry.create(title: "The Notebook", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "97", movie: the_notebook_movie)
    the_holiday = MovieEntry.create(title: "The Holiday", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "20", movie: the_holiday_movie)
    blood_diamond = MovieEntry.create(title: "Blood Diamond", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "45", movie: blood_diamond_movie)
    once = MovieEntry.create(title: "Once", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "90", movie: once_movie)
    ps_i_love_you = MovieEntry.create(title: "P.S. I Love You", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "55", movie: ps_i_love_you_movie)
    american_hustle = MovieEntry.create(title: "American Hustle", seen: 1, own: 0, wishlist_see: 0, wishlist_own: 1, user_rating: "none", movie: american_hustle_movie)
