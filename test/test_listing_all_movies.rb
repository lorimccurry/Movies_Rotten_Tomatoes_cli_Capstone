...
class TestListingMovies < MovieTest
  def test_01_test_returns_relevant_results
    good_will_hunting = MovieEntries.create(title: "Good Will Hunting", seen: "t", own: "t", wishlist_see: "f", wishlist_own: "f", user_rating: "96", environment: "test")
...
Good Will Hunting: seen t, own t, wishlist see f, wishlist own f, user rating: 96, id: #{good_will_hunting.id}
EOS
