...
class TestEnteringMovie < MiniTest::Unit::TestCase
 ...
 def test_03_error_message_for_missing_title
  command = "./movie add -s t -o t --ws f --wo f -r 100"
  expected = "You must provide the title of the movie you are adding"
 ...
 def test_09_valid_movie_information_gets_printed
  command = "./movie add -t 'American Hustle' -s t -o f --ws f --wo t -r 80"
